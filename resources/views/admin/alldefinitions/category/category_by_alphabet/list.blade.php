    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Questions List</h2>
					</div>
                    <div class="body">
												...
												@if(!empty($result))
													@foreach($result as $key=>$value)
														<tr class="gradeX odd"  id="{{ $value->id }}">
                                                            ...
                                                            <td class="center">{{ ucfirst($value['brand_name']) }}</td>
															<td class="center"><img src="{{ asset('uploads/brands/'.$value->image) }}" width="65px"/></td> 
															<td class="center">
                                                            ...
                                                            <td class="center">
                                                                ...
                                                                <a href="{{ url('admin/catalog/brand/brand-update/'.$value['id'] )}}" title="Edit Brand" class="btn btn-tbl-edit">
...
@push('custom_js')
    ...
    <script type="text/javascript">
        ...
        function updateOrder(aData) {        
            $.ajax({
                url: "{{ route('admin.brand.change-order') }}",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                type: 'POST',
