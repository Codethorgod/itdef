	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					<div class="header">
						<h2><i class="fa fa-th"></i> Category</h2>
					</div>
					<div class="body">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<div class="form-line">
										...
										<input type="file" id="uploadImage" class="form-control"  name="image"  data-type="single" data-image-preview="category" accept="image/*"   >
